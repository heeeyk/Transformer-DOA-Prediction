...
The [`mainer`](mainer) sets up a container with a main function for this project. Run ['mainer\main_featurefusion'](mainer\main_featurefusion) to begin training or testing.
